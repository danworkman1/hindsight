// lib/paths.js
// Resolves where hindsight-agent-reviews.log and hindsight-agent-review-cache.json live.
// They live at the git repo root so `tail -f hindsight-agent-reviews.log` works from the
